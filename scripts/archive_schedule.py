...
download_schedules objects are pairs of configurations as dicts:
    ...
    the schedule config
'''
class download_schedule(tuple(dict, dict)):
    def __init__(self, ydl_opts=None, sched_opts=None):
        if ydl_opts == None:
            '''
            based on https://github.com/ytdl-org/youtube-dl/blob/master/README.md#options
